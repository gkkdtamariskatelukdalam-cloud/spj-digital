...
export function LetterheadSettingsPanel() {
  ...
  const lineMeta = [
    { num: 1, label: "Baris 1", placeholder: "Baris atas (instansi)" },
    { num: 2, label: "Baris 2", placeholder: "Baris kedua (dinas)" },
    { num: 3, label: "Baris 3", placeholder: "Baris nama sekolah (terbesar)" },
    { num: 4, label: "Baris 4", placeholder: "Alamat baris 1" },
    { num: 5, label: "Baris 5", placeholder: "Alamat baris 2" },
    { num: 6, label: "Baris 6", placeholder: "Kontak/telp" },
    { num: 7, label: "Baris 7", placeholder: "Website/email" },
  ];
